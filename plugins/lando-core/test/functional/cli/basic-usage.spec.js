...
describe('basic usage', function() {
  ...
  it('requires at least one argument', function() {
    return this.cliTest.exec(this.executable).then((res) => {
  ...
  describe('#config', function() {
    it('returns json string', function() {
      return this.cliTest.exec(this.executable + ' config').then((res) => {
  ...
  describe('#version', function() {
    it('Returns the version specified in the package.json', function() {
      return this.cliTest.exec(this.executable + ' version').then((res) => {
